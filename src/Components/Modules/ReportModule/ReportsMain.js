          ...
          <div className="department-main-heading ">
            ...
            <div className="row">
              <div
                ...
                <div className=" table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl table-responsive-xxl addUser_div w-100">
                  <table class="table">
                    <thead>
                      <tr>
                        <th
    ...
    <div className="dept-modal">
      <Modal
        ...
        <Modal.Body className="role-model-body">
          <h4 className="role-model-body__heading">Reportes seleccionados:</h4>
          <p className="role-model-body__p"> Total 4 </p>
          <ul className="role-model-body__ul">
            <li className="role-model-body__ul__li">
              <span>Reporte 20_20_2022 </span>
            </li>
            <li className="role-model-body__ul__li">
              <span> Reporte Caso María </span>
            </li>
            <li className="role-model-body__ul__li">
              <span> Test </span>
            </li>
